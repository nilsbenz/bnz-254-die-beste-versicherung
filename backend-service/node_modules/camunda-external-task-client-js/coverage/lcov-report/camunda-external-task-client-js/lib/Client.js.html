...
<html lang="en">
<head>
    <title>Code coverage report for camunda-external-task-client-js/lib/Client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">camunda-external-task-client-js/lib</a> Client.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (asyncResponseTimeout) {
<span class="cstat-no" title="statement not covered" >      pollingOptions = { ...pollingOptions, asyncResponseTimeout };</span>
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!isUndefinedOrNull(businessKey)) {
<span class="cstat-no" title="statement not covered" >          topic.businessKey = businessKey;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.emit("poll:error", e);</span>
    }
...
<span class="cstat-no" title="statement not covered" >      this.emit("handler:error", e);</span>
    } finally {
      this.activeTasksCount--;
    }
  }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Oct 29 2019 17:07:51 GMT+0100 (CET)
</div>
</div>
